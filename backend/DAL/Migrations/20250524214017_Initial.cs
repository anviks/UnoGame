        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PileType = table.Column<int>(type: "integer", nullable: false),
                    CardId = table.Column<int>(type: "integer", nullable: false),
                    GameId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PileCard", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PileCard_Cards_CardId",
                        column: x => x.CardId,
                        principalTable: "Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PileCard_Games_GameId",
                        column: x => x.GameId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PileCard_CardId",
                table: "PileCard",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_PileCard_GameId",
                table: "PileCard",
                column: "GameId");
